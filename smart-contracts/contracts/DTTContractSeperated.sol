...
contract DTTContractSeperated is ERC721, ERC721Enumerable {
    ...
    // 1차 NFT 목록 조회
    function getPrItems() public view returns (PrItem[] memory) {
        return prItemArray;
    }

    // 2차 NFT 목록 조회
    function getCdItems() public view returns (CdItem[] memory) {
        return cdItemArray;
    }
}
